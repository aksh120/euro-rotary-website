  ...
  return (
    <div className="w-full max-w-md mx-auto p-10 bg-luxury-black/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl">
      <div className="mb-8 text-center">
        <h2 className="text-3xl font-display text-luxury-gold mb-2">
          Registration
        </h2>
        <p className="text-luxury-silver text-sm">
          Secure your position in the race.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="space-y-2 group">
          ...
          <div className="relative">
            ...
            >
              <option value="" className="bg-luxury-black text-gray-500">
                Select Gender
              </option>
              <option value="male" className="bg-luxury-black">
                Male
              </option>
              <option value="female" className="bg-luxury-black">
                Female
              </option>
              <option value="other" className="bg-luxury-black">
                Other
              </option>
            </select>
        ...
        <div className="pt-4">
          <label className="flex items-start space-x-3 cursor-pointer">
            ...
            <span className="text-xs text-luxury-silver leading-relaxed">
              ...
              <Link
                href="/terms"
                className="text-luxury-gold underline hover:text-white transition-colors"
              >
                Terms and General Conditions
              </Link>{" "}
              of the event. I understand that my registration is not confirmed
