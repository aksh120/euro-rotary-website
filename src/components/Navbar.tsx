        ...
        <>
            ...
            >
                <div className="container mx-auto px-6 flex items-center justify-between">
                    ...
                    {/* Desktop Menu */}
                    <div className="hidden md:flex items-center bg-white/5 px-8 py-2.5 rounded-full border border-white/5 backdrop-blur-md">
                    ...
                    <div className="hidden md:flex items-center">
                        <Link href="/register">
                            <Button variant="primary" size="sm" className="bg-luxury-gold text-black hover:bg-white border-none shadow-[0_0_20px_rgba(212,175,55,0.2)] hover:shadow-[0_0_30px_rgba(212,175,55,0.4)] transition-all">
                                Register
                            </Button>
                        </Link>
                    </div>
                ...
                {isMobileMenuOpen && (
                    ...
                    >
                        <div className="p-6 flex justify-between items-center border-b border-white/5">
                            <span className="text-xl font-display font-bold text-luxury-gold">MENU</span>
                            <button
                        ...
                        <div className="p-8 text-center border-t border-white/5">
                            <p className="text-luxury-silver/40 text-[10px] uppercase tracking-[0.3em]">Euro Rotary 2025 • Monaco</p>
                        </div>
                    </motion.div>
                )}
            </AnimatePresence>
